...
const PartnerNavbar = () => {
    ...
    return (
      ...
      <div className="container-fluid">
        <NavLink className='navbar-brand mx-3' to='/partner/mainscreen'>Home</NavLink>
        ...
        <li><Link className="dropdown-item" to="/login/partner"><LogoutIcon fontSize='small'/> Log out</Link></li>
